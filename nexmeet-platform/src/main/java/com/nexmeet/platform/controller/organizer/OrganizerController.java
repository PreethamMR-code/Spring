...
public class OrganizerController {
    ...
    public String dashboard(Model model, Authentication auth) {
        ...
        if(organizerOpt.isPresent()){
            ...
            long pendingApproval = conferenceService.countByOrganizerAndStatus(organizer.getId(), ConferenceStatus.SUBMITTED);
        ...
        public String createConference(@ModelAttribute("dto") ConferenceCreateDto dto,
            ...
            try {
                ...
                if ("SUBMIT".equals(action)) {
                    flash.addFlashAttribute("success", "Conference submitted for admin approval!");
                } else {
                    flash.addFlashAttribute("success", "Conference saved as draft.");
                }
