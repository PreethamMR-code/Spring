            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <form action="doctor" method="post">
                        ...
                        <!-- Rating -->
                        <div class="mb-3">
                            <label class="form-label">Doctor Rating</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="fee"
                                   class="form-control"
                                   value="${param.fee}">
                            <small class="text-danger">${feeError}</small>
                        </div>
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <label class="form-check-label">Currently Practicing</label>
                        </div>
                        ...
                        <!-- Level -->
                        <div class="mb-3">
                            <label class="form-label">Doctor Level (1–10)</label>
